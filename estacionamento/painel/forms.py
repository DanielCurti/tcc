...
class Vaga(forms.Form):
	...
	segunda = forms.BooleanField(widget=forms.CheckboxInput())
	terca = forms.BooleanField(widget=forms.CheckboxInput())
	quarta = forms.BooleanField(widget=forms.CheckboxInput())
	quinta = forms.BooleanField(widget=forms.CheckboxInput())
	sexta = forms.BooleanField(widget=forms.CheckboxInput())
